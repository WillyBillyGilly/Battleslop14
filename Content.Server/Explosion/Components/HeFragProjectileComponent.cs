...
/// <summary>
/// Projectiles that, when they collide with an entity, explode into multiple projectiles
/// </summary>
[RegisterComponent, Access(typeof(ProjectileFragSystem))]
public sealed partial class HeFragProjectileComponent : Component
{
